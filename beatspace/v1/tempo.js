...
var loop = function () {
  ...
  elements.bpm.html("<br>dynamic bpm: " + produitEnCroix(convertBeat(beatMS), tempoInput.value, 1));
  ...
  elements.beatprogress.html("<br>beat progress: " + parseFloat(beatprogress).toFixed(1) + " " + beatprog);
